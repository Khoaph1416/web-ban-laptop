<section>
        <h2 class="bg-dark p-3 fs-5 text-white mt-5"> SẢN PHẨM NỔI BẬT</h2>
        <div id="data" class="d-flex flex-wrap">
            ...
            <div class="col-md-4">
                <div class="border border-primary m-1 p-2 text-center">
                    ...
                    <a href="/themvaogio/{{$sp->id}}" onclick="return alert('thêm sản phẩm vào giỏ');" class='btn btn-primary px-3'>Thêm vào giỏ hàng</a>
                </div>
            </div>
            @endforeach
        </div>
